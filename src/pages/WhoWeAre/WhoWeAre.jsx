...
export default function WhoWeAre() {
    return <section className="pt-3 sm:pt-7 md:pt-10 pb-5">
        <Helmet>
            <title>من نحن</title>
            <meta name="description" content="رؤيتنا أن نكون الخيار الأول للعملاء في مجال نقل العفش بالرياض من خلال تقديم خدمات موثوقة وآمنة ورسالتنا توفير حلول نقل متكاملة تتسم بالأمان والاحترافية مع الالتزام بالمواعيد وتقديم أفضل الأسعار وقيمنا نقدم خدمات ممتازة بقييم عالية ، الجودة هي رؤيتنا ، والأمان هو هدفنا ، والموثوقية هي قيمنا. نقدر الجودة والاحترافية ولدينا الأمان والموثوقية ونلتزم بالمواعيد التسليمية .  " />
        </Helmet>
        <div className="container space-y-10">
            ...
            <div className="grid grid-cols-12 gap-5 sm:gap-3 px-2 sm:px-0 ">
                <div className="col-span-12 sm:col-span-6 justify-self-center flex flex-col items-center lg:col-span-4 hover:shadow-lg group transition-shadow duration-200 p-10">
                    <i class=" text-5xl group-hover:text-[#0078ff] transition-colors duration-300"><CommentOutlinedIcon fontSize="inherit" /></i>
                ...
                <div className="col-span-12 sm:col-span-6 justify-self-center flex flex-col items-center lg:col-span-4 hover:shadow-lg group transition-shadow duration-200 p-10">
                    <i class="fa-regular fa-pen-to-square text-5xl text-gray-900 group-hover:text-[#0078ff] transition-colors duration-300"></i>
                    <header className="font-cairo text-xl font-bold mt-2">
                ...
                <div className="col-span-12 sm:col-span-6  justify-self-center flex flex-col items-center lg:col-span-4 hover:shadow-lg group transition-shadow duration-200 p-10 w-full">
                    <i class="text-5xl group-hover:text-[#0078ff] transition-colors duration-300"><DiamondIcon fontSize="inherit" /></i>
                    <header className="font-cairo text-xl font-bold mt-2">
